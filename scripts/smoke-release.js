...
try {
  for (const url of ["/", "/api/health", "/api/archive", "/editor/", "/vendor/maplibre-gl.mjs"]) {
  ...
  console.log("Release smoke check passed (archive, public pages, editor assets, PMTiles byte ranges).");
} finally {
